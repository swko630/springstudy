...
//  @RequestMapping(value="/blog/add.do", method=RequestMethod.GET)
  public String add(BlogDto blog) { // 커맨드 객체의 Model 저장 방식 : 클래스 타입을 cammelCase 로 변경해서 저장한다. (BlogDto -> blogDto 로 변경해서 저장)
