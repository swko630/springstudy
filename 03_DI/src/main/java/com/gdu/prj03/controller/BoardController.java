...
//  private BoardService boardService;
//  public BoardController(BoardService boardService) { // 생성자의 매개변수로 자동 주입됨
//    super();
...
//  }
  ...
  // 앞으로 사용할 한 가지 방식
  // final 필드 + 생성자 주입(lombok의 @RequiredArgsConstructor를 이용하여 매개변수의 null 체크를 수행함) - 매개변수의 null체크를 해주는 AllArgsConstructor
