...
public class BlogController {
  ...
  public ResponseEntity<Map<String, Object>> registerComment(HttpServletRequest request) {
   ...
   // return ResponseEntity.ok(Map.of("insertCount", blogService.registerComment(request)); 위에 식과 동일
        }
  ...
  public ResponseEntity<Map<String, Object>> commentList(HttpServletRequest request) {
    return new ResponseEntity<Map<String,Object>>(blogService.getCommentList(request)
                                                 ,HttpStatus.OK);
  }
